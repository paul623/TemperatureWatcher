...
public class testBigFrame extends ApplicationFrame {
    public testBigFrame(String title)
    {
        super(title);
    ...
    public static CategoryDataset createDataset() //创建柱状图数据集
    {
        ...
        dataset.setValue(20,"b","Shopping");
        dataset.setValue(40,"c","Developer");
        dataset.setValue(15,"d","Others");
        return dataset;
    }
    ...
    public static JFreeChart createChart(CategoryDataset dataset) //用数据集创建一个图表
    {
        JFreeChart chart= ChartFactory.createBarChart("hi", "人员分布",
                "Numbers", dataset, PlotOrientation.VERTICAL, true, true, false); //创建一个JFreeChart
    ...
    {
        testBigFrame chart=new testBigFrame("某公司组织结构图");
        chart.pack();//以合适的大小显示
